    ...
    <div class="container" v-if="products && products.length">
      <router-link
        ...
        <div class="box">
          ...
          <p>{{ product.urunAciklama }}</p>
          <div class="urunFiyaDiv">
            <span><b>{{ Number.parseFloat(product.fiyat).toFixed(2)}} TL</b></span>
          </div>
          <div class="sepeteGitIcon">
            <span><FontAwesomeIcon icon="shopping-cart"></FontAwesomeIcon></span>
          </div>
